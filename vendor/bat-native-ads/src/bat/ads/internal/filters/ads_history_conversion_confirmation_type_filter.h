...
#ifndef BAT_ADS_INTERNAL_FILTERS_ADS_HISTORY_CONVERSION_CONFIRMATION_TYPE_FILTER_H_
#define BAT_ADS_INTERNAL_FILTERS_ADS_HISTORY_CONVERSION_CONFIRMATION_TYPE_FILTER_H_
...
#endif  // BAT_ADS_INTERNAL_FILTERS_ADS_HISTORY_CONVERSION_CONFIRMATION_TYPE_FILTER_H_
