...
TEST_F(BatAdsTotalMaxFrequencyCapTest, AdAllowedWithNonMatchingAds) {
  // Arrange
  CreativeAdInfo ad;
...
TEST_F(BatAdsTotalMaxFrequencyCapTest, AdExcludedWhenNoneAllowed) {
  // Arrange
  CreativeAdInfo ad;
  ad.creative_set_id = kCreativeSetIds.at(0);
  ad.total_max = 0;
...
TEST_F(BatAdsTotalMaxFrequencyCapTest, AdExcludedWhenMaximumReached) {
  // Arrange
  CreativeAdInfo ad;
  ad.creative_set_id = kCreativeSetIds.at(0);
  ad.total_max = 5;
